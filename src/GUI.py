...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionExtract_Petrophysics.setObjectName(u"actionExtract_Petrophysics")
        ...
        self.actionMultiple_Linear_Regression.setObjectName(u"actionMultiple_Linear_Regression")
        self.actionSupport_Vector_Machine_Regression = QAction(MainWindow)
        self.actionSupport_Vector_Machine_Regression.setObjectName(u"actionSupport_Vector_Machine_Regression")
        ...
        self.actionSupport_Vector_Machine_Classifier.setObjectName(u"actionSupport_Vector_Machine_Classifier")
        ...
        self.actionGradient_Boosting_Classifier.setObjectName(u"actionGradient_Boosting_Classifier")
        ...
        self.menuClasification_Models.setObjectName(u"menuClasification_Models")
        ...
        self.menuRegression_Models.addAction(self.actionMultiple_Linear_Regression)
        self.menuRegression_Models.addAction(self.actionSupport_Vector_Machine_Regression)
        ...
        self.menuClasification_Models.addAction(self.actionSupport_Vector_Machine_Classifier)
        ...
        self.menuClasification_Models.addAction(self.actionGradient_Boosting_Classifier)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"InnoPetrol", None))
        self.actionCargar.setText(QCoreApplication.translate("MainWindow", u"New Project", None))
        self.actionOpen_Database.setText(QCoreApplication.translate("MainWindow", u"Open Project", None))
        self.actionOpen_Well.setText(QCoreApplication.translate("MainWindow", u"Add Well", None))
        self.actionOpen_Template.setText(QCoreApplication.translate("MainWindow", u"Open Template", None))
        self.actionSelect_Well.setText(QCoreApplication.translate("MainWindow", u"Select Well", None))
        self.actionManage_Zone_Picks.setText(QCoreApplication.translate("MainWindow", u"Manage Zone/Picks", None))
        self.actionCustom_Zones.setText(QCoreApplication.translate("MainWindow", u"Custom Zones", None))
        self.actionExtract_Petrophysics.setText(QCoreApplication.translate("MainWindow", u"Extract Petrophysics", None))
        self.actionScatter_Plot.setText(QCoreApplication.translate("MainWindow", u"Scatter Plot", None))
        self.actionHistogram_Plot.setText(QCoreApplication.translate("MainWindow", u"Histogram Plot", None))
        self.actionHeat_Map.setText(QCoreApplication.translate("MainWindow", u"Heat Map", None))
        self.actionNeural_Network.setText(QCoreApplication.translate("MainWindow", u"Neural Network", None))
        self.actionMultiple_Linear_Regression.setText(QCoreApplication.translate("MainWindow", u"Multiple Linear Regression", None))
        self.actionSupport_Vector_Machine_Regression.setText(QCoreApplication.translate("MainWindow", u"Support Vector Machine Regression", None))
        ...
        self.actionKnearneighbor.setText(QCoreApplication.translate("MainWindow", u"Knearneighbor", None))
        ...
        self.actionSupport_Vector_Machine_Classifier.setText(QCoreApplication.translate("MainWindow", u"Support Vector Machine Classifier", None))
        self.actionNeural_Network_2.setText(QCoreApplication.translate("MainWindow", u"Neural Network", None))
        self.actionNaive_Bayes.setText(QCoreApplication.translate("MainWindow", u"Naive Bayes", None))
        self.actionGradient_Boosting_Classifier.setText(QCoreApplication.translate("MainWindow", u"Gradient Boosting Classifier", None))
        ___qtreewidgetitem = self.treeWidget.headerItem()
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("MainWindow", u"Wells", None));

        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        ___qtreewidgetitem1 = self.treeWidget.topLevelItem(0)
        ___qtreewidgetitem1.setText(0, QCoreApplication.translate("MainWindow", u"Well 1", None));
        ___qtreewidgetitem2 = ___qtreewidgetitem1.child(0)
        ___qtreewidgetitem2.setText(0, QCoreApplication.translate("MainWindow", u"Lines", None));
        ___qtreewidgetitem3 = ___qtreewidgetitem2.child(0)
        ___qtreewidgetitem3.setText(0, QCoreApplication.translate("MainWindow", u"Cali", None));
        ___qtreewidgetitem4 = ___qtreewidgetitem1.child(1)
        ___qtreewidgetitem4.setText(0, QCoreApplication.translate("MainWindow", u"Fills", None));
        ___qtreewidgetitem5 = ___qtreewidgetitem4.child(0)
        ___qtreewidgetitem5.setText(0, QCoreApplication.translate("MainWindow", u"CaliOver", None));
        ___qtreewidgetitem6 = self.treeWidget.topLevelItem(1)
        ___qtreewidgetitem6.setText(0, QCoreApplication.translate("MainWindow", u"Well 2", None));
        ___qtreewidgetitem7 = ___qtreewidgetitem6.child(0)
        ___qtreewidgetitem7.setText(0, QCoreApplication.translate("MainWindow", u"Lines", None));
        ___qtreewidgetitem8 = ___qtreewidgetitem7.child(0)
        ___qtreewidgetitem8.setText(0, QCoreApplication.translate("MainWindow", u"LDI", None));
        ...
        self.menuWell.setTitle(QCoreApplication.translate("MainWindow", u"Well", None))
        ...
        self.menuRegression_Models.setTitle(QCoreApplication.translate("MainWindow", u"Regression Models", None))
        self.menuClasification_Models.setTitle(QCoreApplication.translate("MainWindow", u"Clasification Models", None))
